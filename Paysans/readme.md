...
-  Exercice : une grille https://codepen.io/pixeline/pen/aWavWq  , utilise les grilles css pour placer les éléments.[grille css](https://developer.mozilla.org/fr/docs/Web/CSS/CSS_Grid_Layout/Les_concepts_de_base)
